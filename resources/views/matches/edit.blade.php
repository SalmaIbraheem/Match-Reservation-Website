        ...
        <div class="wrap-login100 ">    
            ...
            <div class="card-body">
                ...
                @csrf
                    ...
                    <div class="wrap-input100 validate-input m-b-10">
                        <label for="referee" style = "color: lightgray;">Away Team</label> 
                    ...
                    <div class="wrap-input100 validate-input m-b-10">
                        ...
                        <input id="date" class="input100 form-control " type="date" name="date" placeholder="date"  value="{{m->date}}" required autocomplete="bday" autofocus> 
                    </div>
